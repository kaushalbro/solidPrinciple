    ...
    public function __construct($model_data)
    {
        parent::__construct();
            ...
            $this->stub_conditions = [ //order should be matched
                'is_api_with_api_resource_classes' => $this->is_api_with_api_resource_classes, 'is_api' => $this->is_api, 'repo_pattern' => $this->repo_pattern, 'laravel_11' => $this->laravel_11, 'laravel_10' => $this->laravel_10, 'is_api_without_api_with_resource_classes' => $this->is_api_without_api_with_resource_classes,];
            $this->setUpRole();
            $this->setUpUser();
    }
