    ...
    public function makeDirectory($path)
    {
        try {
            ...
            if (!$is_directory){
                ...
                error_log(end($path_array).' Folder Created.');
                return $directoryPath;
            }
            error_log(end($path_array).' Folder already Exists.');
        }catch (\Exception $e){
    ...
    public function makeFile($path, $data=null)
    {
        try {
            ...
            if (!$is_file){
                ...
                error_log(end($path_array).' File Created.');
                return $filePath;
            }
            error_log($file_name.' File already Exists');
            return $filePath;
        }catch (\Exception $e){
            error_log($e->getMessage());
        }
